        ...
        <div className="flex flex-wrap space-between">
          ...
          <div className="" id="forPrint">
            ...
            <div className="flex justify-center items-center">
              <MdNavigateBefore
                className="text-5xl cursor-pointer dark:text-white hover:text-blue-400  "
                onClick={prevCard}
              />
          ...
          <div className=" w-[250px] my-3  rounded-lg h-48">
            <div
              ...
              className="bg-white dark:bg-gray-800 flex cursor-pointer mb-4 drop-shadow-md hover:scale-110 rounded-lg w-[250px] p-2 h-10"
            >
              <TfiBackRight className="text-2xl mx-5" />
              Share
            </div>
            <div className="bg-white dark:bg-gray-800 flex cursor-pointer my-4 drop-shadow-md hover:scale-110 rounded-lg w-[250px] p-2 h-10">
            ...
            <div
              ...
              className="bg-white dark:bg-gray-800 flex cursor-pointer my-4 drop-shadow-md hover:scale-110 rounded-lg w-[250px] p-2 h-10"
            >
